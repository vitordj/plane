...
| Disponibilidade, férias, capacidade                        | Parcial               | Modelos `WorkspaceMemberAvailability` e `MembershipAllocationSettings` (migração `0141`, item 3.1), flag `ORCA_AVAILABILITY_ENABLED` (default off). Ranking ainda não lê (item 3.2).                                                                                                                                                  |
