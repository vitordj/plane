...
ORCA_ERROR_CODES = {
    ...
    # availability (item 3.3)
    "ORG_AVAILABILITY_WINDOW_NOT_FOUND": 4938,
    "ORG_AVAILABILITY_INVALID_INTERVAL": 4939,
    "ORG_AVAILABILITY_FROM_REQUIRED": 4940,
    "ORG_WORKSPACE_MEMBER_NOT_FOUND": 4941,
    "ORG_ALLOCATION_LIMIT_FORBIDDEN": 4942,
    "ORG_NOT_AVAILABILITY_MANAGER": 4943,
...
ORCA_ERROR_MESSAGES = {
    ...
    "ORG_AVAILABILITY_WINDOW_NOT_FOUND": "That unavailability period was not found",
    "ORG_AVAILABILITY_INVALID_INTERVAL": "The end of an unavailability period must be after its start",
