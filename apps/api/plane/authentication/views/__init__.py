...
from .app.azuread import AzureADCallbackEndpoint, AzureADOauthInitiateEndpoint
...
from .space.azuread import AzureADCallbackSpaceEndpoint, AzureADOauthInitiateSpaceEndpoint
