...
from .app.entra import EntraCallbackEndpoint, EntraOauthInitiateEndpoint
...
from .space.entra import EntraCallbackSpaceEndpoint, EntraOauthInitiateSpaceEndpoint
