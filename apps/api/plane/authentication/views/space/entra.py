...
"""Public-space sign-in endpoints for Microsoft Entra ID (see FORK.md)."""
...
class EntraOauthInitiateSpaceEndpoint(View):
...
class EntraCallbackSpaceEndpoint(View):
    def get(self, request):
        ...
        try:
            provider = EntraOAuthProvider(request=request, code=code)
