...
class AzureADOauthInitiateEndpoint(View):
    def get(self, request):
        ...
        try:
            ...
            provider = AzureADOAuthProvider(request=request, state=state)
...
class AzureADCallbackEndpoint(View):
    def get(self, request):
        ...
        try:
            provider = AzureADOAuthProvider(request=request, code=code, callback=post_user_auth_workflow)
