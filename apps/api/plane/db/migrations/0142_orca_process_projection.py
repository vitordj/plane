...
#
# Numbered 0142. The original RFC split SLA (0142) and process (0143); this
# migration carries all three models plus the optional completed/review states
# on the assignment policy, matching the source tree on feat/orca-work-management.
# Django binds migrations by dependency, not by number.
#
# Written by hand; confirm with `python3 apps/api/manage.py makemigrations --check --dry-run`.
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("source__in", ["unit_project", "unit", "process", "manual"])),
                name="orca_sla_source_chk",
            ),
        ),
        migrations.AddConstraint(
            model_name="processinstancereference",
            constraint=models.CheckConstraint(
                check=models.Q(("status__in", ["running", "completed", "cancelled"])),
                name="orca_process_status_chk",
            ),
        ),
        migrations.AddConstraint(
            model_name="processinstanceitem",
            constraint=models.CheckConstraint(
                check=models.Q(("completion_mode__in", ["automatic", "automatic_with_review", "manual"])),
                name="orca_process_item_completion_mode_chk",
            ),
        ),
        migrations.AddConstraint(
            model_name="processcompletionevent",
            constraint=models.CheckConstraint(
                check=models.Q(("mode__in", ["automatic", "automatic_with_review", "manual"])),
                name="orca_completion_mode_chk",
            ),
        ),
    ]
