    ...
    class Meta:
        constraints = [
            models.CheckConstraint(
                check=Q(source__in=ServiceLevelSource.values),
...
class ProcessInstanceReference(BaseModel):
    ...
    class Meta:
        constraints = [
            ...
            models.CheckConstraint(
                check=Q(status__in=ProcessInstanceStatus.values),
...
class ProcessInstanceItem(BaseModel):
    ...
    class Meta:
        constraints = [
            ...
            models.CheckConstraint(
                check=Q(completion_mode__in=CompletionMode.values),
...
class ProcessCompletionEvent(AppendOnlyModel):
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                check=Q(mode__in=CompletionMode.values),
