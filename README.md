...
|                        | Remembered Assignees (web app)     | A work item created in the web app with no assignee reuses the assignees of your last one in that project. The public API (`/api/v1`) never does: it uses the project's default assignee, or nobody. |
