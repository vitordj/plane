...
export type TCoreInstanceAuthenticationModeKeys =
  ...
  | "gitlab"
  | "gitea"
  // Microsoft Entra ID sign-in, added by the fork (see FORK.md).
  | "entra";
...
export type TInstanceEntraAuthenticationConfigurationKeys =
  | "ENTRA_TENANT_ID"
  | "ENTRA_CLIENT_ID"
  | "ENTRA_CLIENT_SECRET"
  | "ENABLE_ENTRA_SYNC";
...
export type TInstanceAuthenticationConfigurationKeys =
  ...
  | TInstanceEntraAuthenticationConfigurationKeys;
...
export type TCoreLoginMediums = "email" | "magic-code" | "github" | "gitlab" | "google" | "gitea" | "entra";
